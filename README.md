...
| `DFISE_PARSER_README.md` | This document (consolidated reference) |
| `DF-ISE_GRD_Format_Report_v2.md` | Detailed format specification |
| `PARSER_ROBUSTNESS.md` | Error handling documentation |
| `PARSER_USAGE.md` | API reference and examples |
